...
import witherLogo from "../../assets/images/logo.png";
      ...
      <div className={styles.innerContainer}>
        <Link to="/">
          <div className={styles.logoBlock}>
            <img src={witherLogo} alt="Not Found" className={styles.logo} />
          </div>
        </Link>
        ...
        <div className={styles.socialIconsContainer}>
          <IconSocial href="https://www.instagram.com/witchernetflix/?hl=ru">
            <svg
              viewBox="0 0 32 32"
            ...
            >
              <g>
                <path d="M21.5 11.5C20.9477 11.5 20.5 11.0523 20.5 10.5C20.5 9.94774 20.9477 9.5 21.5 9.5C22.0523 9.5 22.5 9.94774 22.5 10.5C22.4998 11.0523 22.0523 11.5 21.5 11.5Z" />
          ...
          <IconSocial href="https://www.facebook.com/witchernetflix/">
            <svg
              viewBox="0 0 32 32"
              className="socialIcon"
              xmlns="http://www.w3.org/2000/svg"
          ...
          <IconSocial href="https://vk.com/witchernetflix">
            <svg
              viewBox="0 0 32 32"
              className="socialIcon"
              xmlns="http://www.w3.org/2000/svg"
